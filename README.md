...
Таблица ACTION[state, terminal] определяет, что делать, когда на вершине стека состояние state, а следующий входной символ — терминал (или конец ввода $).
Возможные действия: shift, reduce, accept, error.

Таблица GOTO[state, nonterminal] определяет, в какое состояние перейти после того, как вы выполнили reduce и поместили нетерминал на стек.
